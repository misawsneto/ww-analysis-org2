# Test Cases: WorkStation FileTreeContent
...
- [ ] No regressions in the WorkStation file tree panel
- [ ] `pnpm test` passes with no new failures
- [ ] No TypeScript errors (`pnpm typecheck`)
- [ ] No new lint warnings
- [ ] WorkStation's `EditorPrimarySidebar` passes `stickyBgClass` via `usePrimarySidebarSurface()`
- [ ] WorkStation imports from its local `content/FileTreeContent` module
